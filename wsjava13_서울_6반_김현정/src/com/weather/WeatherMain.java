...
public class WeatherMain {
	...
	JButton b;
	JList li;
	WeatherDAO dao; // -> xml문서 읽어와서 parsing -> parsing한 결과를 ArrayList에 저장
					// WeatherVo -> parsing 결과 1건 저장 (vo에 담아서 ArrayList에 저장)

	public WeatherMain() throws Exception {
	...
	protected void showList() {
		...
		try {
			List<Weather> data = dao.getWeatherList();
